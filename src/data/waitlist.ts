...
export const W = {
  ...
  ar: {
    ...
    hero: {
      eyebrow: 'الوصول التجريبي قريباً',
      headline: ['كن من أوائل من', 'يكتشف اتجاهه.'],
      hl: 'يكتشف اتجاهه',
      sub: 'إتجاهي هو مرشدك المهني الشخصي القادم — مبني على ١٥ عاماً من الإرشاد الحقيقي في الخليج، ومعزَّز بالذكاء الاصطناعي ليريك كيف يتغيّر كل مسار بالفعل. نحن نختبره حالياً مع مجموعة مبكرة قبل إتاحته للجميع. اترك بياناتك لتحصل على فرصة للوصول التجريبي المجاني.',
